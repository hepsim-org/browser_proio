...
public class HepSim {
	 ...
	 * Get PDG names.
	 */
	public static Map<Integer, String> GetPDGNames() throws IOException {

		Map<Integer, String> name_map = new HashMap<Integer, String>();

		// Open the file
		InputStream in = HepSim.class.getResourceAsStream("resource/particle.tbl");
